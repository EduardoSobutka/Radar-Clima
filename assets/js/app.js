...
const erorContent = document.querySelector("[data-error-content]");

export const updateWatther = function (lat, lon) {
  loading.style.display = "grid";
  container.style.overflowY = "hidden";
  container.classList.remove("fade-in");

  erorContent.style.display = "none";
  ...
  const forecastSection = document.querySelector("[data-5-day-foreacast]");
  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    fetchData(url.airPollution(lat, lon), function (airPollution) {
      ...
      card.innerHTML = `
        <h2 class="title-2">Destaques de hoje</h2>
...
export const error404 = () => (erorContent.style.display = "flex");
